  ...
  return (
    <nav className="main-navbar dark-navbar" role="navigation" aria-label="Main Navigation">
      <div className="navbar-inner flex items-center justify-between px-4 md:px-12 relative h-full max-w-[1400px] mx-auto">
        ...
        <button 
          id="mobileMenuBtn"
          className="lg:hidden text-white p-2 focus:outline-none z-50 mobile-menu-btn"
        ...
        <div 
          ...
          className="fixed inset-0 bg-[#0d1117]/95 backdrop-blur-lg lg:hidden transition-all duration-500 flex flex-col items-center justify-center z-40 opacity-0 pointer-events-none translate-y-full"
        >
